...
public class StringIntro
{
	...
	public static void printSecondAndLastLetter(String input)
	{
		 ...
		 *     - prints out a modified version of the final print statement with both ' ' being replaced 
		 *       with "[space]"
		 *   - if the check is false, returns a modified version of the final print statement with only 
		 *     one ' ' being replaced with "[space]"
