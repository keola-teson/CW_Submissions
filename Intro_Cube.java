/* 
 * This code calculates the surface area and volume of a side length. I (keola) made this.
 */
package work;
...
//prints into console
System.out.print("The surface area of a cube with the side length " + (int)sideLength + " is ");
